# %% [markdown] {"id":"pCc2m_VLpwG6","jupyter":{"outputs_hidden":false}}
# ##### Copyright 2025 Google LLC.

# %% [code] {"id":"lrOWWTiepwG8","jupyter":{"outputs_hidden":false}}
...
# %% [markdown] {"id":"jP-yDdNYpwG8","jupyter":{"outputs_hidden":false}}
...
# %% [markdown] {"id":"CmgQuX0FpwG9","jupyter":{"outputs_hidden":false}}
...
# %% [markdown] {"id":"1eIDMHeSpwG9","jupyter":{"outputs_hidden":false}}
# ---
# ## ⚙️ Section 1: Setup
# 
...
# %% [markdown] {"id":"mkYnp2HrpwG9","jupyter":{"outputs_hidden":false}}
...
# %% [code] {"id":"X4ge5O5LpwG9","outputId":"e979fed9-ec85-4d7d-da4b-4b92464e880f","execution":{"iopub.status.busy":"2025-11-11T18:51:48.423121Z","iopub.execute_input":"2025-11-11T18:51:48.423545Z","iopub.status.idle":"2025-11-11T18:51:48.581655Z","shell.execute_reply.started":"2025-11-11T18:51:48.423516Z","shell.execute_reply":"2025-11-11T18:51:48.580332Z"},"jupyter":{"outputs_hidden":false}}
import os
...
# %% [markdown] {"id":"KfKu1N7LpwG-","jupyter":{"outputs_hidden":false}}
...
# %% [code] {"id":"QyMjY5_ApwG-","outputId":"e4bd7298-2e43-486c-ed1b-5d76a46a7225","execution":{"iopub.status.busy":"2025-11-11T18:51:51.126533Z","iopub.execute_input":"2025-11-11T18:51:51.126868Z","iopub.status.idle":"2025-11-11T18:52:24.966749Z","shell.execute_reply.started":"2025-11-11T18:51:51.126844Z","shell.execute_reply":"2025-11-11T18:52:24.965291Z"},"jupyter":{"outputs_hidden":false}}
import uuid
...
# %% [code] {"execution":{"iopub.status.busy":"2025-11-11T18:52:24.968390Z","iopub.execute_input":"2025-11-11T18:52:24.969001Z","iopub.status.idle":"2025-11-11T18:52:24.975297Z","shell.execute_reply.started":"2025-11-11T18:52:24.968962Z","shell.execute_reply":"2025-11-11T18:52:24.974214Z"},"jupyter":{"outputs_hidden":false}}
...
# %% [markdown] {"id":"97RRe_Q8pwG_","jupyter":{"outputs_hidden":false}}
# ---
...
# %% [markdown] {"id":"zVvwyGpupwG_","jupyter":{"outputs_hidden":false}}
# ### 2.1: How MCP Works
# 
...
# %% [markdown] {"id":"53QhJFhQpwG_","jupyter":{"outputs_hidden":false}}
...
# %% [code] {"id":"esU6sWB6pwG_","outputId":"8090d690-c972-4974-c04a-064aeadf5f01","jupyter":{"outputs_hidden":false}}
...
# %% [markdown] {"id":"vmrFoVP-pwG_","jupyter":{"outputs_hidden":false}}
# #### **Behind the scenes:**
...
# %% [markdown] {"id":"xyE_Ku-jpwG_","jupyter":{"outputs_hidden":false}}
...
# %% [code] {"id":"YIgCK2ArpwG_","outputId":"be727f7f-b180-4ad1-a7eb-b735eb31f594","jupyter":{"outputs_hidden":false}}
from google.adk.runners import InMemoryRunner

runner = InMemoryRunner(agent=image_agent)

# %% [markdown] {"id":"Ub3Eq2kQpwG_","jupyter":{"outputs_hidden":false}}
...
# %% [markdown] {"id":"VLHI2k7zpwG_","jupyter":{"outputs_hidden":false}}
# ---
...
# %% [code] {"id":"EvHFmXXcpwG_","jupyter":{"outputs_hidden":false}}
...
# %% [code] {"id":"3du-oETLpwHA","jupyter":{"outputs_hidden":false}}
...
# %% [code] {"id":"ftb5tMOepwHA","jupyter":{"outputs_hidden":false}}
...
# %% [markdown] {"id":"ut-5dntSpwHA","jupyter":{"outputs_hidden":false}}
...
# %% [code] {"id":"B_vdPMf9pwHA","jupyter":{"outputs_hidden":false}}
...
# %% [markdown] {"id":"S-A3zIAVpwHB","jupyter":{"outputs_hidden":false}}
# ---
# 
...
# %% [markdown] {"id":"Uas-x3LxpwHE","jupyter":{"outputs_hidden":false}}
...
# %% [code] {"id":"uVaApsoupwHE","jupyter":{"outputs_hidden":false}}
...
# %% [markdown] {"id":"8_DNvktYpwHE","jupyter":{"outputs_hidden":false}}
# ---
# 
...
# %% [code] {"execution":{"iopub.status.busy":"2025-11-11T18:52:32.701215Z","iopub.execute_input":"2025-11-11T18:52:32.701586Z","iopub.status.idle":"2025-11-11T18:52:32.852179Z","shell.execute_reply.started":"2025-11-11T18:52:32.701563Z","shell.execute_reply":"2025-11-11T18:52:32.850833Z"},"jupyter":{"outputs_hidden":false}}
import os
from kaggle_secrets import UserSecretsClient

try:
    HUGGING_FACE_TOKEN = UserSecretsClient().get_secret("HUGGINGFACE_KEY")
    os.environ["HUGGING_FACE_TOKEN"] = HUGGING_FACE_TOKEN
    print("✅ Setup and authentication complete.")
except Exception as e:
    print(
        f"🔑 Authentication Error: Please make sure you have added 'HUGGING_FACE_TOKEN' to your Kaggle secrets. Details: {e}"
    )

# %% [code] {"execution":{"iopub.status.busy":"2025-11-11T18:52:33.795290Z","iopub.execute_input":"2025-11-11T18:52:33.795655Z","iopub.status.idle":"2025-11-11T18:52:33.802476Z","shell.execute_reply.started":"2025-11-11T18:52:33.795629Z","shell.execute_reply":"2025-11-11T18:52:33.801334Z"},"jupyter":{"outputs_hidden":false}}
root_agent = LlmAgent(
    model=Gemini(model="gemini-2.5-flash-lite", retry_options=retry_config),
...
# %% [code] {"execution":{"iopub.status.busy":"2025-11-11T18:52:38.155419Z","iopub.execute_input":"2025-11-11T18:52:38.155787Z","iopub.status.idle":"2025-11-11T18:52:40.319943Z","shell.execute_reply.started":"2025-11-11T18:52:38.155751Z","shell.execute_reply":"2025-11-11T18:52:40.318130Z"},"jupyter":{"outputs_hidden":false}}
from google.adk.runners import InMemoryRunner
from google.adk.sessions import InMemorySessionService

runner_image = InMemoryRunner(agent=root_agent)

respone = await runner_image.run_debug("Can you generate image of a cat", verbose=True)

# %% [code] {"jupyter":{"outputs_hidden":false}}
from IPython.display import display, Image as IPImage
import base64

for event in respone:
    if event.content and event.content.parts:
        for part in event.content.parts:
            if hasattr(part, "function_response") and part.function_response:
                for item in part.function_response.response.get("content", []):
...
hf_mcp = McpToolset(
        connection_params=StreamableHTTPServerParams(
            ...
            tool_filter=["FLUX.1-Krea-dev"]
        )

IMAGE_THRESHOLD = 1

def check_num_requests(num_pictures: int, tool_context: ToolContext, auto_approve: bool = True) -> dict:
    """
    Check whether the numer of pictures requested is not greater than the threshold for 
    the number of pictures that can be generated.

    Args:
        num_pictures: int = The number of pictures that is being requested
        auto_approve: bool = Whether the request has been approved, set to True by default

    Returns:
        dict
    """
    if num_pictures <= IMAGE_THRESHOLD:
        return {
            "status": "approved",
            "num_pictures": f"ORD-{num_pictures}-AUTO",
            "message": f"Order auto-approved: {num_pictures} images",
        }
    
    if not tool_context.tool_confirmation:
        tool_context.request_confirmation(
            hint=f"⚠️ Large order: {num_pictures}. Do you want to approve?",
            payload={"num_pictures": num_pictures},
        )
        return {  # This is sent to the Agent
            "status": "pending",
            "message": f"Order for {num_pictures} containers requires approval",
        }
    ...
    if tool_context.tool_confirmation.confirmed:
        ...
        return {
            "status": "rejected",
            "message": f"Order rejected: {num_pictures} images",
        }

# %% [code] {"jupyter":{"outputs_hidden":false}}
picture_agent = LlmAgent(
    name='Picture_Genrater_Agent',
    instruction="""You are an image generation agent. Before generating images, you must:

1. Check the current number of images using the appropriate tool
2. If the number of images is LESS than the threshold, proceed directly with hf_mcp to generate the image
3. If the number of images is GREATER than or EQUAL to the threshold, ask the user for explicit approval before generating any images

Always inform the user of the current image count and the threshold before taking action.""",
...
# Wrap the agent in a resumable app - THIS IS THE KEY FOR LONG-RUNNING OPERATIONS!
picture_app = App(
    name="picture_coordinator",
    root_agent=picture_agent,
    resumability_config=ResumabilityConfig(is_resumable=True),
)
...
# Create runner with the resumable app
picture_runner = Runner(
    app=picture_app,  # Pass the app instead of the agent
    session_service=session_service,
)
...
async def run_image_generation_workflow(query: str, auto_approve: bool = True):
    ...
    # Create session
    await session_service.create_session(
        app_name="picture_coordinator", user_id="test_user", session_id=session_id
    )
    ...
    # STEP 1: Send initial request to the Agent
    # If num_pictures > IMAGE_THRESHOLD, the Agent returns the special `adk_request_confirmation` event
    async for event in picture_runner.run_async(
        user_id="test_user", session_id=session_id, new_message=query_content
    ):
        events.append(event)
    ...
    # PATH B: If `adk_request_confirmation` is not present - no approval needed - generation completes immediately
    else:
        print_agent_response(events)
    
    print(f"{'='*60}\n")

print("✅ Image generation workflow function ready")

# %% [code] {"jupyter":{"outputs_hidden":false}}
await run_image_generation_workflow("Can I have 1 pictures of a cat please")

# %% [markdown] {"id":"657bqQLCpwHE","jupyter":{"outputs_hidden":false}}
# ---
# 
