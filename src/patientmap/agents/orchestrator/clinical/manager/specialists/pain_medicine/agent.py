...
# Load configuration
try:
    pain_settings = AgentConfig("pain_medicine_agent.yaml").get_agent()
except (FileNotFoundError) as e:
    raise RuntimeError("Pain Medicine agent config not found. Please ensure pain_medicine_agent.yaml exists in the current directory.") from e
