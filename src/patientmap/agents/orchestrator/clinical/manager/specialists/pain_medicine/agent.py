...
# Load configuration
config_path = Path(__file__).parent.parent.parent.parent.parent.parent.parent.parent.parent / ".profiles" / "clinical" / "pain_medicine_agent.yaml"

try:
    config = AgentConfig(str(config_path)).get_agent()
    pain_settings = config
