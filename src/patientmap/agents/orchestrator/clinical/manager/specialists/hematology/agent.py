...
try:
    hematology_settings = AgentConfig("./hematology_agent.yaml").get_agent()
except (FileNotFoundError) as e:
    raise RuntimeError("Hematology agent config not found. Please ensure hematology_agent.yaml exists in the current directory.") from e
