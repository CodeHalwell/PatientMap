...
# Load configuration
config_path = Path(__file__).parent.parent.parent.parent.parent.parent.parent.parent.parent / ".profiles" / "clinical" / "psychiatry_agent.yaml"

try:
    config = AgentConfig(str(config_path)).get_agent()
    psychiatry_settings = config
