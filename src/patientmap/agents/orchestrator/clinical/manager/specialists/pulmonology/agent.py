...
# Load configuration
try:
    pulmonology_settings = AgentConfig("./pulmonology_agent.yaml").get_agent()
except (FileNotFoundError) as e:
    raise RuntimeError("Pulmonology agent config not found. Please ensure pulmonology_agent.yaml exists in the current directory.") from e
