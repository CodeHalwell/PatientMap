...
# Load configuration
try:
    neurology_settings = AgentConfig("./neurology_agent.yaml").get_agent()
except (FileNotFoundError) as e:
    raise RuntimeError("Neurology agent config not found. Please ensure neurology_agent.yaml exists in the current directory.") from e
